...
mano_hand = mano_layer(anno)
mano = mano_hand
utils.add_mesh_to_fig(fig4, mano.vertices[0], mano_layer.faces, opacity=0.2)
fig4.add_trace(
    go.Scatter3d(
        x=mano.joints[0][:, 0],
        y=mano.joints[0][:, 1],
...
_add_points(fig4, Xmean_joints, 'j','red')
_add_points(fig4, Xmean_fingers, 'f', 'green')
_add_points(fig4, Xmean_palms, 'p', 'orange')
_add_lines(fig4, Xmean_joints, [[0,1,2,3,4], [0,5,6,7], [0,8,9,10], [0,11,12,13], [0,14,15,16]], 'Ymean_joints', 'red')
_add_lines(fig4, Xmean_palms, [[0,1,2,3], [0,4], [4,5,6,7], [3,7]], 'parms', 'orange')

_add_points(fig4, Ymean_joints, 'j','red')
_add_points(fig4, Ymean_fingers, 'f', 'green')
_add_points(fig4, Ymean_palms, 'p', 'orange')
_add_lines(fig4, Ymean_joints, [[0,1,2,3,4], [0,5,6,7], [0,8,9,10], [0,11,12,13], [0,14,15,16]], 'Ymean_joints', 'red')
_add_lines(fig4, Ymean_palms, [[0,1,2,3], [0,4], [4,5,6,7], [3,7]], 'parms', 'orange')
